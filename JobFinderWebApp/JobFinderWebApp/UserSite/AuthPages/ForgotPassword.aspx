<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite/AuthPages/AuthPages.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="JobFinderWebApp.UserSite.AuthPages.ForgotPassword" %>
    ...
    <div class="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                <p>Don't have an account? <a href="Register.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a></p>
            </div>
        </div>
    </div>
