<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite/AuthPages/AuthPages.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="JobFinderWebApp.UserSite.AuthPages.Register" %>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Already have an account? <a href="Login.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">Sign in</a>
                </p>
            </div>
