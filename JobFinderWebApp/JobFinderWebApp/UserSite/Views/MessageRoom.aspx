...
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="bg-white border-b border-gray-200 px-4 py-3 flex items-center sticky top-0 z-10 shadow-sm">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="customAlert" class="fixed top-5 right-5 z-50 max-w-xs w-full transition-all duration-300 transform translate-x-full">
        <div class="bg-red-500 text-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-4 flex items-center">
                ...
                <div id="alertMessage" class="flex-1 text-sm"></div>
                <button onclick="closeAlert()" class="ml-3 opacity-80 hover:opacity-100">
    ...
    <div class="max-w-2xl mx-auto bg-white rounded-t-lg shadow-sm h-full flex flex-col border border-gray-200">
        <div class="flex-1 overflow-y-auto p-4 message-container" id="messageContainer" runat="server">
