<%@ Page Title="" Language="C#" MasterPageFile="~/CompanySite/AuthPages/AuthPages.Master" AutoEventWireup="true" CodeBehind="CompanyLogin.aspx.cs" Inherits="JobFinderWebApp.CompanySite.AuthPages.CompanyLogin" %>
    ...
    <div class="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="mt-4 text-2xl font-bold text-gray-900">Company Sign In</h1>
                <p class="mt-2 text-sm text-gray-600">
                    Or <a href="CompanyRegister.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">create a company account</a>
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                <div class="p-6 sm:p-8">
                    <div class="space-y-6" runat="server">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="CompanyForgotPassword.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="text-sm text-center text-gray-600">
                        Don't have a company account? <a href="CompanyRegister.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">Register now</a>
                    </div>
                </div>
            </div>
        </div>
