    ...
    <div class="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="mt-4 text-2xl font-bold text-gray-900">Reset Company Password</h1>
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                <p>Don't have a company account? <a href="CompanyRegister.aspx" class="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a></p>
            </div>
        </div>
    </div>
